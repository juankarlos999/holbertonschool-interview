...
def DisplayBoard(board):
    '''la función acepta un parámetro el cual contiene el estado actual del
    tablero y lo muestra en la consola.
    '''
...
def EnterMove(board):
    ...
    acerca de su movimiento, verifica la entrada y actualiza el tablero acorde
...
def MakeListOfFreeFields(board):
    '''la funcion examina el tablero y construye una lista de todos los cuadros
    vacios la lista esta compuesta por tuplas, cada tupla es un par de números
